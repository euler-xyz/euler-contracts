...
.test({
    ...
    actions: ctx => [
        ...
        // 50% of liquidity tracking period, 10% supplier bonus
        ...
        // 100% of liquidity tracking period, 20% supplier bonus
        { action: 'jumpTimeAndMine', time: 86400 / 2, },
        ...
        // 110% of liquidity tracking period - bonus maxed out
        ...
        // 50% of liquidity tracking period, 35% supplier bonus
        { action: 'jumpTimeAndMine', time: 86400 / 2, },
        { callStatic: 'liquidation.checkLiquidation', args: [ctx.wallet.address, ctx.wallet2.address, ctx.contracts.tokens.TST.address, ctx.contracts.tokens.TST2.address],
            onResult: r => {
                et.equals(r.healthScore, 0.99995, 0.00001);
        ...
        // 100% of liquidity tracking period, 70% supplier bonus
        { action: 'jumpTimeAndMine', time: 86400 / 2, },
        ...
        // 50% of liquidity tracking period, 50% supplier bonus
        { action: 'jumpTimeAndMine', time: 86400 / 2, },
        { callStatic: 'liquidation.checkLiquidation', args: [ctx.wallet.address, ctx.wallet2.address, ctx.contracts.tokens.TST.address, ctx.contracts.tokens.TST2.address],
            onResult: r => {
                et.equals(r.healthScore, 0.99995, 0.00001);
        ...
        // 100% of liquidity tracking period, 100% supplier bonus
        { action: 'jumpTimeAndMine', time: 86400 / 2, },
        ...
        // 50% of liquidity tracking period, 25% supplier bonus
        { action: 'jumpTimeAndMine', time: 86400 / 2, },
        { callStatic: 'liquidation.checkLiquidation', args: [ctx.wallet.address, ctx.wallet2.address, ctx.contracts.tokens.TST.address, ctx.contracts.tokens.TST2.address],
            onResult: r => {
                et.equals(r.healthScore, 0.99995, 0.00001);
        ...
        // 100% of liquidity tracking period, 25% /2 + 50% = 65% supplier bonus
        { action: 'jumpTimeAndMine', time: 86400 / 2, },
        ...
        // limited by MAXIMUM_SUPPLIER_DISCOUNT
...
.test({
    ...
    actions: ctx => [
        ...
        { send: 'exec.trackAverageLiquidity', args: [0, ctx.wallet4.address], },
        { from: ctx.wallet4, send: 'exec.trackAverageLiquidity', args: [0, ctx.wallet.address], },
        ...
        // liquidator's linked account tracked assets are 30% of violator's liability
        { from: ctx.wallet4, send: 'eTokens.eTST2.deposit', args: [0, et.eth(30)], },
        ...
        // linked account withdraws half for 25% of tracking period
        { from: ctx.wallet4, send: 'eTokens.eTST2.withdraw', args: [0, et.eth(25)], },
        { action: 'jumpTimeAndMine', time: 86400 / 4, },
        ...
        // liquidator withdraws more
        // { send: 'eTokens.eTST2.withdraw', args: [0, et.eth(10)], },
        // { action: 'jumpTimeAndMine', time: 86400 / 4, },

        // // 25% * 0.75 + 10% * 0.25 = 21.25%
        // { callStatic: 'liquidation.checkLiquidation', args: [ctx.wallet.address, ctx.wallet2.address, ctx.contracts.tokens.TST.address, ctx.contracts.tokens.TST2.address],
        //     onResult: r => {
        //         et.equals(r.healthScore, 0.99995, 0.00001);
        //         et.equals(r.discount, 0.012125, 0.0001);
        //     },
        // },
    ],
})
