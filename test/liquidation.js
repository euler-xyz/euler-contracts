...
.test({
    desc: "discount scales with discount booster",
    actions: ctx => [
...
.test({
    ...
    actions: ctx => [
        ...
        { from: ctx.wallet4, send: 'exec.trackAverageLiquidity', args: [0, et.AddressZero], },
        ...
        { send: 'exec.approveAverageLiquidityDelegation', args: [0, ctx.wallet4.address], },
        ...
        { send: 'exec.approveAverageLiquidityDelegation', args: [0, et.AddressZero], },
        { callStatic: 'liquidation.checkLiquidation', args: [ctx.wallet.address, ctx.wallet2.address, ctx.contracts.tokens.TST.address, ctx.contracts.tokens.TST2.address],
            onResult: r => {
                et.equals(r.healthScore, 0.99995, 0.00001);
                et.equals(r.discount, 0.01, 0.0001);
