...
.test({
    ...
    actions: ctx => [
        ...
        { call: 'eTokens.eTST.balanceOfUnderlying', args: [ctx.wallet.address], equals: et.eth(10), },
        { call: 'eTokens.eTST.balanceOfUnderlying', args: [ctx.wallet2.address], equals: et.eth(10), },
        ...
        { call: 'eTokens.eTST.balanceOfUnderlying', args: [ctx.wallet.address], equals: et.eth(10.1), },
        { call: 'eTokens.eTST.balanceOfUnderlying', args: [ctx.wallet2.address], equals: et.eth(10.1), },
        ...
        { call: 'tokens.TST.balanceOf', args: [ctx.wallet.address], equals: et.eth(10.1), },

        { call: 'tokens.TST.balanceOf', args: [ctx.contracts.euler.address], equals: et.eth(10.1), },
    ],
})
