...
interface ISwapHandler {
    ...
    /// @param exactOutTolerance Maximum difference between requested amountOut and received tokens in exact output swap
    /// @param payload multi-purpose byte param. The usage depends on he swap handler's implementation
    struct SwapParams {
