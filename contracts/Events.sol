...
abstract contract Events {
    ...
    event DelegateAverageLiquidity(address indexed account, address indexed to);
    event ApproveAverageLiquidityDelegation(address indexed account, address indexed from);
